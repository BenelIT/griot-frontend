  ...
  return (
    <>
      <div className="min-h-screen flex items-center justify-center px-4 py-8 bg-griot-cream">
        ...
        >
          {/* Form column */}
          <Card className="border-0 rounded-none md:rounded-l-3xl lg:px-12 bg-griot-cream overflow-y-auto">
            <AuthHeader subtitle="Create your Griot account" />

            <CardContent>
              <form className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <Label className="text-griot-dark font-sans">
                      First Name
                    </Label>
                    <Input
                      type="text"
                ...
                <div className="space-y-2">
                  <Label className="text-griot-dark font-sans">Username</Label>
                  <Input
                    type="text"
                    placeholder="johndoe"
                    className="bg-muted/20 focus-visible:ring-2 focus-visible:ring-griot-teal"
            ...
            <CardFooter className="flex flex-col items-center mt-2 text-xs text-griot-gray px-6 pb-6">
